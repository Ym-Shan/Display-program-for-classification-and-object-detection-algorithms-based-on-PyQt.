...
from view_py.project_management import Ui_MainWindow
...
class MainWindow(Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.helper = project_management_helper()
        self.flash_table()
    ...
    def delete_project(self):
        if self.tableWidget.selectedItems():
            ...
            shutil.rmtree('../data_out/' + title)  # 删除默认的结果文件夹
    ...
    def change_project_name(self):
        if self.tableWidget.selectedItems():
            ...
            if name and ok:
                ...
                # 修改本地文件夹的名字
                os.rename('../data_out/' + title, '../data_out/' + name)
                self.flash_table()
    ...
    def view_analyse(self):
        if self.tableWidget.selectedItems():
            ...
            self.new_window = data_visualization_controller.MainWindow(title)
